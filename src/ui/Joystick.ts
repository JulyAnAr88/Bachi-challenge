import { Sprite, Graphics, Container, InteractionData, Point, InteractionEvent } from "pixi.js";
...
export interface JoystickChangeEvent {
  ...
  export class Joystick extends Container {
    ...
    protected bindEvents() {
      ...
      function onDragEnd(_event: InteractionEvent) {
      ...
      function onDragMove(_event: InteractionEvent) {
        if (dragging == false) { return; }
